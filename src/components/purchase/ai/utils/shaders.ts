...
export const backdropVertexShader = `precision highp float;
...
export const backdropFragmentShader = `precision highp float;
...
export const sphereVertexShader = `#define STANDARD
