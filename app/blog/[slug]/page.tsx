...
export async function generateMetadata(
  ...
  return {
    title: `${blog.title} | Yachu Hair Oil Blog`,
    ...
    openGraph: {
      ...
      images: [
        {
          url: BASE_URL + blog.thumbnail_image,
        },
      ],
    },
    twitter: {
      ...
      title: blog.title,
      description: blog.blog_content,
      images: [BASE_URL + blog.thumbnail_image],
    },
  };
}
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="w-full">
              ...
              {/* Owner*/}
              <section className="flex flex-row items-center me-8 mt-8 mb-8">
                <div className="flex flex-row">
                  <Image
                    width={40}
                    height={40}
                    className="object-cover border-none rounded-full bg-slate-400 "
                    src={"/yachu.jpg"}
                    alt="blog-author"
                  />
                </div>
