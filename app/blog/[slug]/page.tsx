                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="mt-12 sm:mt-16 lg:grid lg:grid-cols-12 lg:gap-x-16 xl:gap-x-24">
                            ...
                            <div className="overflow-hidden bg-white border border-gray-200">
                                <div className="px-4 py-5 sm:p-6">
                                    ...
                                    <ul className="mt-8 space-y-5">
                                        <li>
                                            <a href="#" title="" className="flex text-base font-bold text-gray-500 hover:underline"> What is growth hack? </a>
                                        </li>

                                        <li>
                                            <a href="#" title="" className="flex text-base font-bold text-gray-900 hover:underline"> How to start growing business? </a>
                                        </li>

                                        <li>
                                            <a href="#" title="" className="flex text-base font-bold text-gray-500 hover:underline"> 5 easy hacks to get started </a>
                                        </li>

                                        <li>
                                            <a href="#" title="" className="flex text-base font-bold text-gray-500 hover:underline"> Growth hacking in 2022 </a>
                                        </li>

                                        <li>
                                            <a href="#" title="" className="flex text-base font-bold text-gray-500 hover:underline"> Conclusion </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <p className="text-lg font-bold">Tincidunt magnis eu, vitae dictumst commodo dolor in. Aen ean dictumst risus posuere a at id fermentum nibh. Luctus nunc bibendum duis egestas scelerisque.</p>
                            ...
                            <img className="w-full" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/blog-content/2/image.png" alt="" />
                            ...
                            <blockquote className="flex items-start">
                                ...
                                <p className="ml-4">Tempor, risus, congue gravida nulla tincidunt nec diam. Tincidunt magnis eu, vitae dictumst commodo dolor in. Aenean dictumst risus posuere.</p>
                            </blockquote>
